...
- **Note (T-1160):** the recorder screen has no viewport-anchored bottom CTA (its Stop button sits inside the centered camera preview), so it needed no safe-area padding.
...
- [ ] iOS Safari: bottom CTAs (Rehearse next take, Save to cloud, Record a take) clear of the Safari toolbar / home indicator.
